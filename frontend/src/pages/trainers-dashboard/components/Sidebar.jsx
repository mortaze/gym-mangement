...
const menuItems = [
  ...
  },
  {
    ...
    icon: <Coffee size={20} />,
    href: "/trainers-dashboard/cafe-menu",
  },
];
...
function MenuItem({ item, pathname, onClose, level = 0 }) {
  ...
  const isActive = pathname
    ? item.href === "/trainers-dashboard"
      ? pathname === "/trainers-dashboard"
        ...
        <div
          className={`flex items-center justify-between rounded-xl p-3 mb-1 transition-all duration-200 cursor-pointer ${
            isActive
              ...
              : "text-[var(--text-muted)] hover:bg-gray-100 hover:text-[var(--text-body)] dark:hover:bg-yellow-400/10 dark:hover:text-yellow-400"
          }`}
          style={{ paddingRight }}
        >
          <div
