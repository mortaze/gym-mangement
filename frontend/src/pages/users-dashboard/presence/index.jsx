...
export default function UserPresencePage() {
  ...
  return (
    <DashboardLayout>
      <div
        className="p-4 sm:p-8 min-h-screen rounded-4xl bg-[var(--bg-body)]"
        dir="rtl"
      >
        ...
        <div className="mb-10 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
          <div>
            ...
            <p className="text-[var(--text-muted)] text-xs font-bold mt-2 flex items-center gap-2 uppercase tracking-widest">
              <Flame size={14} className="text-orange-500" />
              Warrior Presence & Subscription Fuel
            </p>
          </div>
          <div className="bg-gray-800/50 px-4 py-2 rounded-xl border border-[var(--border)]">
            <span className="text-[var(--text-dim)] text-[10px] font-black block uppercase">
              آخرین ورود
            </span>
            <span className="text-[var(--text-body)] font-bold text-sm">دیروز - ۱۸:۳۰</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-[var(--bg-card)] p-8 rounded-[2.5rem] border border-[var(--border)] relative overflow-hidden shadow-2xl">
              <h3 className="text-[var(--text-body)] font-black italic mb-6 flex items-center gap-2">
              ...
              <div className="relative h-[220px] w-full flex items-center justify-center">
                ...
                <div className="absolute flex flex-col items-center">
                  <span className="text-4xl font-black text-[var(--text-body)] italic">
              ...
              <div className="space-y-4 mt-6">
                <div className="flex justify-between items-center p-4 bg-[var(--bg-hover)]/50 rounded-2xl border border-[var(--border)]">
                ...
                <div className="flex justify-between items-center p-4 bg-[var(--bg-hover)]/50 rounded-2xl border border-[var(--border)]">
                  ...
                  <span className="text-[var(--text-body)] text-xs font-black font-mono">
              ...
              <Link
                href={"finance"}
                className="w-full mt-8 bg-yellow-400 hover:bg-[var(--bg-card)] text-[var(--text-body)] font-black py-4 rounded-2xl transition-all active:scale-95 flex items-center justify-center gap-2"
              >
          ...
          <div className="lg:col-span-2">
            <div className="bg-[var(--bg-card)] p-8 rounded-[2.5rem] border border-[var(--border)] shadow-2xl h-full">
              <div className="flex justify-between items-center mb-8">
                <h3 className="text-[var(--text-body)] font-black italic flex items-center gap-2 uppercase tracking-tighter text-xl">
                  <Calendar size={22} className="text-yellow-400" /> گزارش نبرد
                  هفتگی
                </h3>
                <div className="flex items-center gap-2 text-[var(--text-muted)] text-xs font-bold">
                  ...
                  <div
                    ...
                    className={`p-6 rounded-[2rem] border transition-all duration-300 ${
                      item.status === "present"
                        ...
                        : "bg-[var(--bg-hover)]/40 border-[var(--border)] border-dashed"
                    }`}
                  >
                    <div className="flex justify-between items-start mb-4">
                      ...
                      {item.status === "present" ? (
                        ...
                        <Clock size={18} className="text-[var(--text-body)]" />
                      )}
                    </div>
                    <p className="text-[var(--text-body)] text-lg font-black italic">
                      {item.date}
                    </p>
                    <p
              ...
              <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-6">
                <div className="bg-[var(--bg-hover)]/80 p-6 rounded-2xl border border-[var(--border)] text-center">
                  <p className="text-[var(--text-muted)] text-[10px] font-black uppercase mb-1">
                    جلسات تمرین ماه
                  </p>
                  <h4 className="text-2xl font-black text-[var(--text-body)] italic">
                    ۱۸{" "}
                    <span className="text-xs text-[var(--text-muted)] tracking-normal">
                      جلسه
                    </span>
                  </h4>
                </div>
                ...
                <div className="bg-[var(--bg-hover)]/80 p-6 rounded-2xl border border-[var(--border)] text-center border-b-yellow-400 border-b-2">
                  <p className="text-[var(--text-muted)] text-[10px] font-black uppercase mb-1">
                    امتیاز وفاداری
                  </p>
                  <h4 className="text-2xl font-black text-[var(--text-body)] italic">
        ...
        <div className="mt-8 p-6 bg-blue-500/5 border border-blue-500/10 rounded-3xl flex items-center gap-4">
          ...
          <div>
            <h5 className="text-[var(--text-body)] text-sm font-black">نکته امنیتی</h5>
